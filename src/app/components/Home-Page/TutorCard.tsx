...
export const TutorCard: React.FC<TutorCardProps> = ({
  ...
  return (
    <div className="flex flex-col justify-center px-0  py-1.5 min-w-60 w-full md:w-[305px] ">
      <article className="w-full lg:w-[290px] bg-white rounded-xl border  border-neutral-200">
        <div id={generatedId} className="flex flex-col items-center px-5 py-6 w-full bg-white rounded-xl border-2 border-solid border-neutral-200">
          ...
          <img
            ...
            className="object-contain mt-5 max-w-full aspect-square w-[100px]"
          />
          ...
          <button onClick={handleViewProfile} className="flex gap-2.5 items-center mt-3">
            <span className="font-Barlow gap-2.5 self-stretch pt-0.5 pb-1 my-auto text-sm font-medium text-stone-900">
              View Profile
            </span>
